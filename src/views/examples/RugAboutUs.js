...
class RugAboutUs extends React.Component {
  state = {};
  componentDidMount() {
        ...
        <main ref="main">
              ...
              <Container className="py-lg-md d-flex" fluid>
                ...
                <Row className="row-grid align-items-center">
                    ...
                    <div className="pr-md-5">
                        ...
                        <h1 className="header-bold">About Us</h1>
                        
                       
                        <ul className="unorderd-list">
                        <li>
                          <i className="fa fa-check-square-o icon-checked" ></i>
                          <span className="list-text">Carpet & Rug Cleaning Since 1894</span>
                        </li>
                        <li>
                          <i className="fa fa-check-square-o icon-checked" ></i>
                          <span className="list-text">Two 10,000+ Sq. Ft. Rug Cleaning & Repair Facilities</span>
                        </li>
                        <li>
                          <i className="fa fa-check-square-o icon-checked" ></i>
                          <span className="list-text">Strategically Located in East and West Toronto</span>
                        </li>
                        <li>
                          <i className="fa fa-check-square-o icon-checked" ></i>
                          <span className="list-text">Weekly Pickup & Delivery in Ontario</span>
                        </li>
                      </ul>
                    </div>
                    <div>
          ...
          <section className="section section-lg">
            ...
            <Container fluid>
              <Row>
              <Col lg="4">
                  <RugCard header1="Persian Rug Cleaning"
                    para1="We offer the most secure, highest quality Persian rug cleaning in Toronto and Ontario..."
                    btn1="Persian Rug Cleaning"
                    img="spr1.png"
                  />
                </Col>
                <Col lg="4">
                  <RugCard header1="Oriental Rug Cleaning"
                    para1=" We are rated as the best oriental rug cleaner in the country. We'll make your Oriental carpet look new..."
                    btn1="Oriental Rug Cleaning"
                    img="spr2.png"
                  />

                </Col>
                <Col lg="4">
                  <RugCard header1="Silk Rug Cleaning"
                    para1="Our silk rug cleaning process is as delicate as your beloved silk area rug. We have cleaned 1000's of silk rugs..."
                    btn1="Silk Rug Cleaning"
                    img="spr3.png"
                  />
                </Col>
